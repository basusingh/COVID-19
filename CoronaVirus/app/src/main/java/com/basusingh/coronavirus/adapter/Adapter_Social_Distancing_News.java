...
public class Adapter_Social_Distancing_News extends RecyclerView.Adapter<Adapter_Social_Distancing_News.ViewHolder> {

private Context context;
private List<SocialDistancingNewsItems> list;

public Adapter_Social_Distancing_News(Context mContext, List<SocialDistancingNewsItems> mItems){
...
public static class ViewHolder extends RecyclerView.ViewHolder{
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, int position){
        final SocialDistancingNewsItems i = list.get(position);
